      ...
      <Box pos="relative">
        ...
        <Stack
          ...
          fontWeight={800}
            ...
            lineHeight={'130%'}
            >
            Competition is complex out there,
          ...
          <InputGroup>
            ...
            />
            <Input borderColor="gray.400" rounded="full" py={6} pr={6} pl={12} type="text" placeholder="Try 'GST Registration'" />
        </InputGroup>
          <Stack
            direction={'column'}
            spacing={3}
